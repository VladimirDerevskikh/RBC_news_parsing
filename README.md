...
количество поясняющих комментариев, а полное объяснение кода данного проекта дается в настоящей документации "readme.txt". 
Кроме того, выложен файл 'rbc_Санкт-Петербург_10_09_2020-19_09_2020.csv', содержащий результаты работы программы. При 
отображении в Excel могут возникнуть проблемы с кодировкой по умолчанию, так как в данной программе сохранение производится в 
кодировке "koi-8" (для того, чтобы правильно записывались всевозможные символы, например, знак рубля), а в Excel может быть 
